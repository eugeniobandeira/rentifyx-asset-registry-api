...
| DEF-003 | Owner-facing "revert PendingModeration asset back to Draft after rejection" path | Not in plan scope for F-09; rejected assets currently stay in PendingModeration indefinitely until an admin approves them |
